...
dependencies {
    ...
    implementation("no.nav.aap.kelvin:server:2.0.42")
    implementation("no.nav.aap.kelvin:infrastructure:2.0.42")
    ...
    testImplementation("org.flywaydb:flyway-core:12.4.0")
