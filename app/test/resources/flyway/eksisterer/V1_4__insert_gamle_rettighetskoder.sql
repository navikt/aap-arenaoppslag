...
insert into VEDTAK (VEDTAK_ID, VEDTAKSTATUSKODE, VEDTAKTYPEKODE, UTFALLKODE, RETTIGHETKODE, PERSON_ID, FRA_DATO, TIL_DATO)
values
    ('995555', 'IVERK', 'O', 'JA', 'AAP', '996', to_date('27.08.2019', 'DD.MM.RRRR'),NULL),
...
insert into VEDTAK (VEDTAK_ID, VEDTAKSTATUSKODE, VEDTAKTYPEKODE, UTFALLKODE, RETTIGHETKODE, PERSON_ID, FRA_DATO, TIL_DATO)
values
    ('994444', 'AVSLU', 'O', 'JA', 'AFLYT', '997', to_date('27.08.2023', 'DD.MM.RRRR'),to_date('04.02.2024', 'DD.MM.RRRR')),
    ('994445', 'IVERK', 'E', 'JA', 'AHJMR', '997', to_date('27.08.2022', 'DD.MM.RRRR'),to_date('04.02.2024', 'DD.MM.RRRR')),
    ('994446', 'IVERK', 'G', 'JA', 'AAP', '997', to_date('31.12.2022', 'DD.MM.RRRR'),NULL),
    -- disse tre skal filtreres ut
    ('994447', 'IVERK', 'G', 'JA', 'AAP', '997', to_date('31.12.2016', 'DD.MM.RRRR'),NULL),
    ('994448', 'IVERK', 'G', 'JA', 'AAP', '997', NULL,NULL),
    ('994449', 'IVERK', 'G', 'JA', 'AAP', '997', to_date('03.01.2020', 'DD.MM.RRRR'),to_date('31.12.2017', 'DD.MM.RRRR'));
