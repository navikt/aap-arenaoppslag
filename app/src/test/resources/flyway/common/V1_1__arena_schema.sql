...
(
    "DIAGNOSEKLASSEKODE" VARCHAR2(10) NOT NULL,
    "DIAGNOSEKLASSENAVN" VARCHAR2(50) NOT NULL,
    CONSTRAINT "DIAGKL_PK" PRIMARY KEY ("DIAGNOSEKLASSEKODE")
);

COMMENT ON COLUMN "DIAGNOSEKLASSE"."DIAGNOSEKLASSEKODE" IS 'Unik ID';
COMMENT ON COLUMN "DIAGNOSEKLASSE"."DIAGNOSEKLASSENAVN" IS 'Navn på diagnoseklassen';
COMMENT ON TABLE "DIAGNOSEKLASSE" IS 'Angir etter hvilket system diagnosen er gitt';
...
(
    "DIAGNOSEKODE"       VARCHAR2(10)              NOT NULL,
    "DIAGNOSEKLASSEKODE" VARCHAR2(10)              NOT NULL,
    "DIAGNOSENAVN"       VARCHAR2(255)             NOT NULL,
    "DATO_FRA"           DATE                      NOT NULL,
    "DATO_TIL"           DATE,
    "REG_DATO"           DATE                      NOT NULL,
    "REG_USER"           VARCHAR2(8)               NOT NULL,
    "MOD_DATO"           DATE                      NOT NULL,
    "MOD_USER"           VARCHAR2(8)               NOT NULL,
    "HOVEDDIAGNOSE_JN"   VARCHAR2(1) DEFAULT 'J'   NOT NULL,
    CONSTRAINT "DIAG_PK" PRIMARY KEY ("DIAGNOSEKODE", "DIAGNOSEKLASSEKODE"),
    CONSTRAINT "DIAG_CK1" CHECK (HOVEDDIAGNOSE_JN IN ('J', 'N')),
    CONSTRAINT "DIAG_DIAGKL_FK" FOREIGN KEY ("DIAGNOSEKLASSEKODE")
        REFERENCES "DIAGNOSEKLASSE" ("DIAGNOSEKLASSEKODE")
);

COMMENT ON COLUMN "DIAGNOSE"."DIAGNOSEKODE" IS 'Diagnosekode';
COMMENT ON COLUMN "DIAGNOSE"."DIAGNOSEKLASSEKODE" IS 'Referanse til DIAGNOSEKLASSE';
COMMENT ON COLUMN "DIAGNOSE"."DIAGNOSENAVN" IS 'Navn på diagnosen';
COMMENT ON COLUMN "DIAGNOSE"."DATO_FRA" IS 'Fra-dato for diagnosens gyldighetsperiode';
COMMENT ON COLUMN "DIAGNOSE"."DATO_TIL" IS 'Evt. til-dato for diagnosens gyldighetsperiode';
COMMENT ON COLUMN "DIAGNOSE"."HOVEDDIAGNOSE_JN" IS 'Angir om det er en hoveddiagnose eller ikke (J/N)';
COMMENT ON TABLE "DIAGNOSE" IS 'Inneholder koden for en diagnose innenfor en diagnoseklasse.';

CREATE INDEX "DIAG_DIAGKL_FKI" ON "DIAGNOSE" ("DIAGNOSEKLASSEKODE");

--------------------------------------------------------------------------------
-- ATTFORINGOPPLYSNING
-- FK-ene ATTFOPPL_ATAARS_FK og ATTFOPPL_HENVITYP_FK er utelatt fordi
-- ATTFORINGAARSAKTYPE og HENVISERTYPE ikke finnes i testskjemaet.
--------------------------------------------------------------------------------
CREATE TABLE "ATTFORINGOPPLYSNING"
(
    "ATTFORINGOPPLYSNING_ID"    NUMBER        NOT NULL,
    "PERSON_ID"                 NUMBER        NOT NULL,
    "HENVISERKODE"              VARCHAR2(10),
    "BESKRIVELSE_DIAGNOSE"      VARCHAR2(1000),
    "BESKRIVELSE_ARBEIDSEVNE"   VARCHAR2(1000),
    "BESKRIVELSE_SOSIALFORHOLD" VARCHAR2(1000),
    "SJEKK_JA_FORMIDLINGSOPPL"  VARCHAR2(1),
    "DATO_SAMTYKKE"             DATE,
    "REG_USER"                  VARCHAR2(8),
    "MOD_USER"                  VARCHAR2(8),
    "REG_DATO"                  DATE,
    "MOD_DATO"                  DATE,
    "DATO_HENVIST"              DATE,
    "ATTFORINGAARSAKKODE"       VARCHAR2(10)  NOT NULL,
    "SJEKK_NEI_INNSYN"          VARCHAR2(1)   NOT NULL,
    "KRONISK_SYKDOM"            VARCHAR2(400),
    "EPHORTE_ID"                VARCHAR2(100),
    CONSTRAINT "ATTFOPPL_PK" PRIMARY KEY ("ATTFORINGOPPLYSNING_ID"),
    CONSTRAINT "ATTFOPPL_UK" UNIQUE ("PERSON_ID"),
    CONSTRAINT "ATTFOPPL_CK3" CHECK (SJEKK_JA_FORMIDLINGSOPPL IN ('J')),
    CONSTRAINT "ATTFOPPL_CK" CHECK (SJEKK_NEI_INNSYN IN ('J', 'N')),
    CONSTRAINT "ATTFOPPL_PERS_FK" FOREIGN KEY ("PERSON_ID")
        REFERENCES "PERSON" ("PERSON_ID")
);

COMMENT ON COLUMN "ATTFORINGOPPLYSNING"."ATTFORINGOPPLYSNING_ID" IS 'Unik ID';
COMMENT ON COLUMN "ATTFORINGOPPLYSNING"."PERSON_ID" IS 'Referanse til PERSON';
COMMENT ON COLUMN "ATTFORINGOPPLYSNING"."HENVISERKODE" IS 'Angir evt. typen henviser. Referanse til HENVISERTYPE.';
COMMENT ON COLUMN "ATTFORINGOPPLYSNING"."BESKRIVELSE_DIAGNOSE" IS 'Beskrivelse av evt. diagnose';
COMMENT ON COLUMN "ATTFORINGOPPLYSNING"."BESKRIVELSE_ARBEIDSEVNE" IS 'Beskrivelse av arbeidsevnen';
COMMENT ON COLUMN "ATTFORINGOPPLYSNING"."BESKRIVELSE_SOSIALFORHOLD" IS 'Beskrivelse av sosiale forhold';
COMMENT ON COLUMN "ATTFORINGOPPLYSNING"."SJEKK_JA_FORMIDLINGSOPPL" IS 'Angir om formidlingsrelaterte opplysninger finnes';
COMMENT ON COLUMN "ATTFORINGOPPLYSNING"."DATO_SAMTYKKE" IS 'Dato for samtykke';
COMMENT ON COLUMN "ATTFORINGOPPLYSNING"."DATO_HENVIST" IS 'Dato for henvisning';
COMMENT ON COLUMN "ATTFORINGOPPLYSNING"."ATTFORINGAARSAKKODE" IS 'Angir attføringsårsaken. Referanse til ATTFORINGAARSAKTYPE';
COMMENT ON COLUMN "ATTFORINGOPPLYSNING"."SJEKK_NEI_INNSYN" IS 'Settes til N når søker av helsemessige årsaker ikke skal ha innsyn i attføringsopplysninger';
COMMENT ON COLUMN "ATTFORINGOPPLYSNING"."KRONISK_SYKDOM" IS 'Angir om evt. sykdom er kronisk';
COMMENT ON COLUMN "ATTFORINGOPPLYSNING"."EPHORTE_ID" IS 'Link til Ephorte';
COMMENT ON TABLE "ATTFORINGOPPLYSNING" IS 'Inneholder tekstlig beskrivelse av personens diagnose, arbeidsevne og sosiale forhold i tillegg til om opplysningene gjelder medisinske eller sosiale forhold.';

CREATE INDEX "ATTFOPPL_HENVITYP_FKI" ON "ATTFORINGOPPLYSNING" ("HENVISERKODE");
CREATE INDEX "ATTFOPPL_ATAARS_FKI" ON "ATTFORINGOPPLYSNING" ("ATTFORINGAARSAKKODE");

--------------------------------------------------------------------------------
-- MEDISINSK_OPPLYSNING
-- FK-ene MEDOPL_DIAGTYP_FK og MEDOPL_MEDOPKIL_FK er utelatt fordi
-- DIAGNOSETYPE og MEDISINSK_OPPL_KILDETYPE ikke finnes i testskjemaet.
-- ATTFORINGSOPPLYSNING_ID (med ekstra S) er skrevet slik i Arena.
--------------------------------------------------------------------------------
CREATE TABLE "MEDISINSK_OPPLYSNING"
(
    "MEDISINSK_OPPLYSNING_ID" NUMBER       NOT NULL,
    "ATTFORINGSOPPLYSNING_ID" NUMBER       NOT NULL,
    "DIAGNOSEKLASSEKODE"      VARCHAR2(10) NOT NULL,
    "DIAGNOSETYPEKODE"        VARCHAR2(5)  NOT NULL,
    "DIAGNOSEKODE"            VARCHAR2(10) NOT NULL,
    "KILDE_DATO"              DATE         NOT NULL,
    "KILDEKODE"               VARCHAR2(10) NOT NULL,
    "REG_DATO"                DATE,
    "REG_USER"                VARCHAR2(8),
    "MOD_DATO"                DATE,
    "MOD_USER"                VARCHAR2(8),
    CONSTRAINT "MEDOPL_PK" PRIMARY KEY ("MEDISINSK_OPPLYSNING_ID"),
    CONSTRAINT "MEDOPL_ATTFOPPL_FK" FOREIGN KEY ("ATTFORINGSOPPLYSNING_ID")
        REFERENCES "ATTFORINGOPPLYSNING" ("ATTFORINGOPPLYSNING_ID"),
    CONSTRAINT "MEDOPL_DIAG_FK" FOREIGN KEY ("DIAGNOSEKODE", "DIAGNOSEKLASSEKODE")
        REFERENCES "DIAGNOSE" ("DIAGNOSEKODE", "DIAGNOSEKLASSEKODE")
);

COMMENT ON COLUMN "MEDISINSK_OPPLYSNING"."MEDISINSK_OPPLYSNING_ID" IS 'Entydlig kode som identifiserer en meldeformtype';
COMMENT ON COLUMN "MEDISINSK_OPPLYSNING"."ATTFORINGSOPPLYSNING_ID" IS 'Referanse til ATTFORINGOPPLYSNING';
COMMENT ON COLUMN "MEDISINSK_OPPLYSNING"."DIAGNOSEKLASSEKODE" IS 'Refererer sammen med DIAGNOSETYPE til DIAGNOSE';
COMMENT ON COLUMN "MEDISINSK_OPPLYSNING"."DIAGNOSETYPEKODE" IS 'Referanse til DIAGNOSETYPE (Hoved eller BI-diagnose)';
COMMENT ON COLUMN "MEDISINSK_OPPLYSNING"."DIAGNOSEKODE" IS 'Refererer sammen med DIAGNOSEKLASSE til DIAGNOSE';
COMMENT ON COLUMN "MEDISINSK_OPPLYSNING"."KILDE_DATO" IS 'Dato for medisinsk opplysning (fra kilde)';
COMMENT ON COLUMN "MEDISINSK_OPPLYSNING"."KILDEKODE" IS 'MEDISINSK_OPPL_KILDETYPE';
COMMENT ON TABLE "MEDISINSK_OPPLYSNING" IS 'Inneholder alle diagnoser for personens attføringsopplysning og kilden for diagnosen.Vises i personmappen under Tilleggsopplysninger';

CREATE INDEX "MEDOPL_MEDOPKIL_FKI" ON "MEDISINSK_OPPLYSNING" ("KILDEKODE");
CREATE INDEX "MEDOPL_DIAGTYP_FKI" ON "MEDISINSK_OPPLYSNING" ("DIAGNOSETYPEKODE");
CREATE INDEX "MEDOPL_ATTFOPPL_FKI" ON "MEDISINSK_OPPLYSNING" ("ATTFORINGSOPPLYSNING_ID");
CREATE INDEX "MEDOPL_DIAG_FKI" ON "MEDISINSK_OPPLYSNING" ("DIAGNOSEKLASSEKODE", "DIAGNOSEKODE");
CREATE INDEX "MEDOPL_DIAG_FK2I" ON "MEDISINSK_OPPLYSNING" ("DIAGNOSEKODE", "DIAGNOSEKLASSEKODE");
