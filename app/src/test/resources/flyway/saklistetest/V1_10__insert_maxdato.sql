...
values
    -- person 100, sak 1102
    (1101, 'AAPVILKUNN', '30-06-2025', DATE '2010-08-29'),
    (1100, 'AAPVILKUNN', '30-05-2025', DATE '2009-01-01'),
    (1109, 'AAPVILKUNN', '31-12-2024', DATE '2024-01-01'),
    -- person 100, sak 1103
    (1103, 'AAPVILKUNN', '30-06-2025', DATE '2022-08-30'),
    (1108, 'AAPVILKUNN', '30-06-2025', DATE '2023-01-01'),
    -- person 101 — skal ikke komme med
    (1111, 'AAPVILKUNN', '30-06-2025', DATE '2020-01-01');
...
insert into VEDTAKFAKTA (VEDTAK_ID, VEDTAKFAKTAKODE, VEDTAKVERDI, REG_DATO)
values
    (1121, 'AAPVILKUNN', '30-06-2025', DATE '2010-08-29'),
    (1122, 'AAPVILKUNN', '30-06-2026', DATE '2011-01-01'),
    (1131, 'AAPVILKUNN', '30-06-2025', DATE '2020-01-01');

insert into VEDTAKFAKTA (VEDTAK_ID, VEDTAKFAKTAKODE, VEDTAKVERDI, REG_DATO)
values
    (1121, 'UNNTAKAAP', 'J', DATE '2010-08-29'),
    (1122, 'UNNTAKAAP', 'J', DATE '2011-01-01'),
    (1131, 'UNNTAKAAP', 'J', DATE '2020-01-01');
